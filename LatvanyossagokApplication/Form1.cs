...
namespace LatvanyossagokApplication
{
    public partial class Form1 : Form
    {
        ...
        {
            if (textBoxVarosNev.Text == " " || textBoxVarosNev.Text == "" || textBoxLakossag.Text == "0")
            {
        ...
        {
            if (textBoxLatvanyossagNev.Text == " " || textBoxLatvanyossagNev.Text == "" || listBoxVaros.SelectedIndex == -1)
            {
                MessageBox.Show("Hibás kitöltés!");
            }
            else {
        ...
        private void buttonVarosModositas_Click(object sender, EventArgs e)
        {
            var varos = (Varos)listBoxVaros.SelectedItem;
            var id = varos.Id;
            var cmd = conn.CreateCommand();
        ...
        private void buttonLatvanyossagMosositas_Click(object sender, EventArgs e)
        {
            var latvanyossag = (Latvanyossag)listBoxLatvanyossag.SelectedItem;
            var id = latvanyossag.Id;
            var varos = (Varos)listBoxVaros.SelectedItem;
